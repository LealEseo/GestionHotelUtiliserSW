 ...
 * generated in the fr.eseo.ee.serviceweb package. 
...
public class ObjectFactory {
    ...
    private final static QName _AnnulerChambre_QNAME = new QName("http://serviceweb.ee.eseo.fr/", "annulerChambre");
    private final static QName _AnnulerChambreResponse_QNAME = new QName("http://serviceweb.ee.eseo.fr/", "annulerChambreResponse");
    private final static QName _Connexion_QNAME = new QName("http://serviceweb.ee.eseo.fr/", "connexion");
    private final static QName _ConnexionResponse_QNAME = new QName("http://serviceweb.ee.eseo.fr/", "connexionResponse");
    private final static QName _PayerChambre_QNAME = new QName("http://serviceweb.ee.eseo.fr/", "payerChambre");
    private final static QName _PayerChambreResponse_QNAME = new QName("http://serviceweb.ee.eseo.fr/", "payerChambreResponse");
    private final static QName _ReserverChambre_QNAME = new QName("http://serviceweb.ee.eseo.fr/", "reserverChambre");
    private final static QName _ReserverChambreResponse_QNAME = new QName("http://serviceweb.ee.eseo.fr/", "reserverChambreResponse");
    private final static QName _TrouverChambre_QNAME = new QName("http://serviceweb.ee.eseo.fr/", "trouverChambre");
    private final static QName _TrouverChambreResponse_QNAME = new QName("http://serviceweb.ee.eseo.fr/", "trouverChambreResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: fr.eseo.ee.serviceweb
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://serviceweb.ee.eseo.fr/", name = "annulerChambre")
     ...
     */
    @XmlElementDecl(namespace = "http://serviceweb.ee.eseo.fr/", name = "annulerChambreResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://serviceweb.ee.eseo.fr/", name = "connexion")
     ...
     */
    @XmlElementDecl(namespace = "http://serviceweb.ee.eseo.fr/", name = "connexionResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://serviceweb.ee.eseo.fr/", name = "payerChambre")
     ...
     */
    @XmlElementDecl(namespace = "http://serviceweb.ee.eseo.fr/", name = "payerChambreResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://serviceweb.ee.eseo.fr/", name = "reserverChambre")
     ...
     */
    @XmlElementDecl(namespace = "http://serviceweb.ee.eseo.fr/", name = "reserverChambreResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://serviceweb.ee.eseo.fr/", name = "trouverChambre")
     ...
     */
    @XmlElementDecl(namespace = "http://serviceweb.ee.eseo.fr/", name = "trouverChambreResponse")
